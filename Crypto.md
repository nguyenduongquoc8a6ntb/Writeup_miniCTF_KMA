...
## Python code
> [!CAUTION]
> - Em thao tác thủ công qua CMD và thu được $a_1$, $a_2$, $c$.

```python
a1 = 
a2 = 
c = 
e = 65537

import math
p = math.gcd((2**e) - a1, (3**e) - a2)
phi = p-1
d = pow(e,-1,phi)
m = pow(c,d,p)
flag = bytes.fromhex(hex(m)[2:])
...
- Ta thực hiện một số theo tác biến đổi đại số:
  ...
  - Thay $m_1^3 = c_1$ vào:
    ...
    > $3.a^2.b.m_1^2 + 3.a.b^2.m_1 + b^3 + a^3.c_1 - c_2 \equiv 0 \pmod n$ <br>
    > Đặt $A = 3a^2b$ ; $B = 3ab^2$ ; $C = b^3 + a^3.c_1 - c_2$ <br>
